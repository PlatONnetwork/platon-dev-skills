> Compatibility note
>
> This file documents upstream Blockscout address-related endpoints. It is broader than the current `platon-blockscout` command set, and not every endpoint listed here is guaranteed to be enabled on PlatON mainnet or devnet.
>
